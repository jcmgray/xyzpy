...
Contributions to `xyzpy` in the form of
[pull requests](https://github.com/jcmgray/xyzpy/pulls) are very welcome.
Opening an [issue](https://github.com/jcmgray/xyzpy/issues) first can be
...
Please read and follow the [`xyzpy` Code of Conduct](../CODE_OF_CONDUCT.md).
...
[development guide](https://xyzpy.readthedocs.io/en/latest/develop.html)
